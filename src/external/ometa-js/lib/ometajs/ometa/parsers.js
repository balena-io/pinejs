(function(root, factory) {
    "function" == typeof define && define.amd ? define([ "exports", "ometa-core" ], factory) : "object" == typeof exports ? factory(exports, require("../core")) : factory(root, root.OMeta);
    ...
    BSOMetaTranslator.jumpTableCode = function(cases) {
        ...
        for (var i = 0; cases.length > i; ++i) buf.push("case " + cases[i][0] + ":return " + cases[i][1] + ";");
    ...
    JumpTable.prototype.toTree = function() {
        for (var r = [ "JumpTable" ], choiceKeys = Object.getOwnPropertyNames(this.choices).sort(), i = 0; choiceKeys.length > i; i++) r.push([ choiceKeys[i], this.choices[choiceKeys[i]] ]);
        return r;
    };
