define(['underscore', 'Prettify', 'ometa-core'], (function(_, Prettify) {
    var AbstractSQLValidator = objectThatDelegatesTo(OMeta, {
        "Query": function() {
        ...
        "SelectQuery": function() {
            var _fromIdx = this.input.idx,
                where, query, queryPart, select, $elf = this,
                from;
            query = ['SelectQuery'];
            this._form((function() {
        ...
        "And": function() {
            var boolStatement1, _fromIdx = this.input.idx,
                boolStatement2, $elf = this;
            this._form((function() {
    ...
    var AbstractSQLOptimiser = objectThatDelegatesTo(AbstractSQLValidator, {
        "Not": function() {
            var _fromIdx = this.input.idx,
                $elf = this,
                boolStatement;
