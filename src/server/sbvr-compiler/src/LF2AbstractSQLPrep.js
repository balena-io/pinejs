define(['sbvr-compiler/LFOptimiser', 'underscore'], (function(LFOptimiser, _) {
    ...
    var LF2AbstractSQLPrep = objectThatDelegatesTo(LFOptimiser, {
        ...
        "AtomicFormulation": function() {
            var _fromIdx = this.input.idx,
                factType, actualFactType, $elf = this;
        ...
        "ForeignKey": function(v1) {
            var card, atomicForm, _fromIdx = this.input.idx,
                necessity, factType, actualFactType, v2, $elf = this;
