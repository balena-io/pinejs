...
], (Serial, Integer, Real, Date, DateTime, Time, Text, ShortText, Color, Hashed, Boolean, JSON, File) ->
	return {Serial, Integer, Real, Date, 'Date Time': DateTime, Time, Text, 'Short Text': ShortText, Color, Hashed, Boolean, JSON, File}
)