define(['SBVRParser', 'SBVR2SQL', 'SBVR_PreProc'], function(SBVRParser, SBVR2SQL, SBVR_PreProc) {
	var testModel = [
		[
			...
			'	Synonym: pupil',
			[ "term", "student", [ [ "Definition", [ "var", [ "num", 0 ], [ "term", "person" ], [ "atLeastQ", [ "minCard", [ "num", 1 ] ], [ "var", [ "num", 1 ], [ "term", "educational institution" ] ], [ "aFrm", [ "fcTp", [ "term", "person" ], [ "verb", "is enrolled in" ], [ "term", "educational institution" ] ], [ "bind", [ "term", "person" ], 0 ], [ "bind", [ "term", "educational institution" ], 1 ] ] ] ] ], [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "pupil" ] ] ],
			[ "term", "student", [ [ "Definition", [ "var", [ "num", 0 ], [ "term", "person" ], [ "existQ", [ "var", [ "num", 1 ], [ "term", "educational institution" ] ], [ "aFrm", [ "fcTp", [ "term", "person" ], [ "verb", "is enrolled in" ], [ "term", "educational institution" ] ], [ "bind", [ "term", "person" ], 0 ], [ "bind", [ "term", "educational institution" ], 1 ] ] ] ] ], [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "pupil" ], [ "DatabaseIDField", "id" ], [ "DatabaseNameField", "name" ], [ "DatabaseTableName", "student" ] ] ],
			[ "term", "student", "student", [ [ "Text", "name", "Name", [] ] ], "CREATE TABLE \"student\" (\"id\" INTEGER PRIMARY KEY AUTOINCREMENT,\"name\" TEXT)", "DROP TABLE \"student\";" ] 
		], [
			'	Synonymous Form: A synonymous form',
			[ "term", "student", [ [ "Definition", [ "var", [ "num", 0 ], [ "term", "person" ], [ "atLeastQ", [ "minCard", [ "num", 1 ] ], [ "var", [ "num", 1 ], [ "term", "educational institution" ] ], [ "aFrm", [ "fcTp", [ "term", "person" ], [ "verb", "is enrolled in" ], [ "term", "educational institution" ] ], [ "bind", [ "term", "person" ], 0 ], [ "bind", [ "term", "educational institution" ], 1 ] ] ] ] ], [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "pupil" ], [ "SynonymousForm", "A synonymous form" ] ] ],
			[ "term", "student", [ [ "Definition", [ "var", [ "num", 0 ], [ "term", "person" ], [ "existQ", [ "var", [ "num", 1 ], [ "term", "educational institution" ] ], [ "aFrm", [ "fcTp", [ "term", "person" ], [ "verb", "is enrolled in" ], [ "term", "educational institution" ] ], [ "bind", [ "term", "person" ], 0 ], [ "bind", [ "term", "educational institution" ], 1 ] ] ] ] ], [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "pupil" ], [ "SynonymousForm", "A synonymous form" ], [ "DatabaseIDField", "id" ], [ "DatabaseNameField", "name" ], [ "DatabaseTableName", "student" ] ] ],
			[ "term", "student", "student", [ [ "Text", "name", "Name", [] ] ], "CREATE TABLE \"student\" (\"id\" INTEGER PRIMARY KEY AUTOINCREMENT,\"name\" TEXT)", "DROP TABLE \"student\";" ] 
		], [
		...
		[
			...
			'	Synonym: A synonym',
			[ "fcTp", [ "term", "student" ], [ "verb", "is school president" ], [ [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "A synonym" ] ] ],
			[ "fcTp", [ "term", "student" ], [ "verb", "is school president" ], [ [ "Source", "A source" ], [ "DictionaryBasis", "A dictionary basis" ], [ "GeneralConcept", "A general concept" ], [ "ConceptType", [ "term", "person" ] ], [ "Necessity", "A necessity" ], [ "Possibility", "A possibility" ], [ "ReferenceScheme", "A reference scheme" ], [ "Note", "A note" ], [ "Example", "An example" ], [ "Synonym", "A synonym" ], [ "DatabaseIDField", "id" ], [ "DatabaseTableName", "student-is_school_president" ] ] ],
			[ "fcTp", "student-is_school_president", "student is school president", [ [ "ForeignKey", "student_table_id", "student_table", [ "student_table", "id", "name" ] ] ], "CREATE TABLE \"student-is_school_president\" (\"id\" INTEGER PRIMARY KEY AUTOINCREMENT, \"student_table_id\" INTEGER, FOREIGN KEY (\"student_table_id\") REFERENCES \"student_table\"(\"id\"))", "DROP TABLE \"student-is_school_president\";", [ [ "term", "student" ], [ "verb", "is school president" ] ] ]
		], [
			'	Synonymous Form: A synonymous form',
