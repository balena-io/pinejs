(function() {
  ...
  define(['data-frame/ClientURIUnparser', 'utils/createAsyncQueueCallback', 'ejs'], function(ClientURIUnparser, createAsyncQueueCallback, ejs) {
    ...
    requirejs(['data-frame/widgets/inputText', 'data-frame/widgets/inputTextArea', 'data-frame/widgets/inputForeignKey'], function(inputText, inputTextArea, inputForeignKey) {
      templates.widgets.inputText = inputText;
      templates.widgets.inputTextArea = inputTextArea;
      return templates.widgets.inputForeignKey = inputForeignKey;
    });
    baseTemplateVars = {
      templates: templates
    };
