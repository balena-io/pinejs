(function() {
  ...
  define(['data-frame/ClientURIUnparser', 'utils/createAsyncQueueCallback', 'ejs'], function(ClientURIUnparser, createAsyncQueueCallback, ejs) {
    ...
    requirejs(['data-frame/widgets/inputText', 'data-frame/widgets/inputTextArea', 'data-frame/widgets/inputForeignKey', 'data-frame/widgets/inputInteger', 'data-frame/widgets/inputBoolean'], function(inputText, inputTextArea, inputForeignKey, inputInteger, inputBoolean) {
      ...
      return templates.widgets.inputBoolean = inputBoolean;
    });
    baseTemplateVars = {
      templates: templates
    };
