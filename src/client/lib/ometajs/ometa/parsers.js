{
    ...
    BSSemActionParser = BSJSParser._extend({
    ...
    BSOMetaTranslator = OMeta._extend({
        App: function() {
        ...
        Grammar: function() {
            ...
            return [ "var ", name, exported ? "=window." + name : "", "=", sName, "._extend({", rules.join(","), "})" ].join("");
        },
        intPart: function() {
    ...
    BSOMetaJSParser = BSJSParser._extend({
        srcElem: function() {
            var _fromIdx = this.input.idx, r, $elf = this;
            return this._or(function() {
                this._apply("spaces");
    ...
    BSOMetaJSTranslator = BSJSTranslator._extend({
        Grammar: function() {
            var _fromIdx = this.input.idx, r, $elf = this;
    ...
    BSNullOptimization = OMeta._extend({
        setHelped: function() {
            var _fromIdx = this.input.idx, $elf = this;
    ...
    BSAssociativeOptimization = BSNullOptimization._extend({
        And: function() {
            var _fromIdx = this.input.idx, $elf = this, x, xs;
            return this._or(function() {
                x = this._apply("trans");
    ...
    BSPushDownSet = BSNullOptimization._extend({
        Set: function() {
    ...
    BSSeqInliner = BSNullOptimization._extend({
        App: function() {
    ...
    BSJumpTableOptimization = BSNullOptimization._extend({
        Or: function() {
    ...
    BSOMetaOptimizer = OMeta._extend({
