...
(function() {
  var calculateLineColInfo, compileOmeta, compileOmetaFile, doCompile, filePath, fs, fsWatcher, knownOpts, load, nopt, parsed, parsingError, shortHands, translationError, vm, _i, _len, _ref;
