...
(function() {
  var calculateLineColInfo, compileOmeta, compileOmetaFile, doCompile, filePath, fs, fsWatcher, js_beautify, knownOpts, load, nopt, parsed, parsingError, shortHands, translationError, vm, _i, _len, _ref;
