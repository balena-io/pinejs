...
(function() {
  var calculateLineColInfo, compileOmeta, compileOmetaFile, doCompile, filePath, fs, js_beautify, knownOpts, load, nopt, parsed, parsingError, shortHands, translationError, vm, _fn, _i, _len, _ref;
