...

{
    ...
    var BSOMetaParser = exports.BSOMetaParser = objectThatDelegatesTo(OMeta, {
        ...
        expr4: function(ne) {
            var $elf = this, _fromIdx = this.input.idx, xs, act, xs, xs;
            return this._or(function() {
                return function() {
                    xs = this._many(function() {
        ...
        rule: function() {
            ...
            return function() {
                ...
                return [ "Rule", n, this["params"], this["locals"], [ "Or", x ].concat(xs) ];
            }.call(this);
        },
        rulePart: function(rn) {
            var $elf = this, _fromIdx = this.input.idx, n, p, b, b;
            return function() {
    ...
    var BSOMetaTranslator = exports.BSOMetaTranslator = objectThatDelegatesTo(OMeta, {
        ...
        Rule: function() {
            var $elf = this, _fromIdx = this.input.idx, name, ps, ls, body;
            return function() {
                name = this._apply("anything");
                this["rName"] = name;
    ...
    var BSAssociativeOptimization = exports.BSAssociativeOptimization = objectThatDelegatesTo(BSNullOptimization, {
        ...
        transInside: function(t) {
            var $elf = this, _fromIdx = this.input.idx, xs, ys, x, xs;
            return this._or(function() {
                return function() {
                    this._form(function() {
                        return function() {
    ...
    var BSJumpTableOptimization = exports.BSJumpTableOptimization = objectThatDelegatesTo(BSNullOptimization, {
        ...
        jtChoices: function(op) {
            var $elf = this, _fromIdx = this.input.idx, c, jt, c;
            return function() {
