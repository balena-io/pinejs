...
"binding":function(){var $elf=this,_fromIdx=this.input.idx,n,v,n;return this._or((function(){return (function(){n=this._applyWithArgs("token","name");this._applyWithArgs("token","=");v=this._apply("asgnExpr");return [n,v]}).call(this)}),(function(){return (function(){n=this._applyWithArgs("token","name");return [n]}).call(this)}))},
...
"semAction":function(){var $elf=this,_fromIdx=this.input.idx,r;return this._or((function(){return this._apply("curlySemAction")}),(function(){return (function(){r=this._apply("primExpr");this._apply("spaces");return r}).call(this)}))}});var BSJSIdentity=exports.BSJSIdentity=objectThatDelegatesTo(OMeta,{
"trans":function(){var $elf=this,_fromIdx=this.input.idx,t,ans,t;return this._or((function(){return (function(){this._form((function(){return (function(){t=this._apply("anything");return ans=this._applyWithArgs("apply",t)}).call(this)}));return ans}).call(this)}),(function(){return (function(){this._form((function(){return t=this._apply("anything")}));return t}).call(this)}))},
...
"regExp":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("anything");return ["regExp",x]}).call(this)},
...
"getp":function(){var $elf=this,_fromIdx=this.input.idx,fd,x;return (function(){fd=this._apply("trans");x=this._apply("trans");return ["getp",fd,x]}).call(this)},
...
"if":function(){var $elf=this,_fromIdx=this.input.idx,cond,t,e;return (function(){cond=this._apply("trans");t=this._apply("curlyTrans");e=this._apply("curlyTrans");return ["if",cond,t,e]}).call(this)},
...
"doWhile":function(){var $elf=this,_fromIdx=this.input.idx,body,cond;return (function(){body=this._apply("curlyTrans");cond=this._apply("trans");return ["doWhile",body,cond]}).call(this)},
...
"forIn":function(){var $elf=this,_fromIdx=this.input.idx,x,arr,body;return (function(){x=this._apply("trans");arr=this._apply("trans");body=this._apply("curlyTrans");return ["forIn",x,arr,body]}).call(this)},
...
"func":function(){var $elf=this,_fromIdx=this.input.idx,args,body;return (function(){args=this._apply("anything");body=this._apply("curlyTrans");return ["func",args,body]}).call(this)},
...
"new":function(){var $elf=this,_fromIdx=this.input.idx,cls,args;return (function(){cls=this._apply("anything");args=this._many((function(){return this._apply("trans")}));return ["new",cls].concat(args)}).call(this)},
"var":function(){var $elf=this,_fromIdx=this.input.idx,vs;return (function(){vs=this._many1((function(){return this._apply("varItem")}));return ["var"].concat(vs)}).call(this)},
"varItem":function(){var $elf=this,_fromIdx=this.input.idx,n,v,n;return this._or((function(){return (function(){this._form((function(){return (function(){n=this._apply("anything");return v=this._apply("trans")}).call(this)}));return [n,v]}).call(this)}),(function(){return (function(){this._form((function(){return n=this._apply("anything")}));return [n]}).call(this)}))},
"throw":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("trans");return ["throw",x]}).call(this)},
"try":function(){var $elf=this,_fromIdx=this.input.idx,x,name,c,f;return (function(){x=this._apply("curlyTrans");name=this._apply("anything");c=this._apply("curlyTrans");f=this._apply("curlyTrans");return ["try",x,name,c,f]}).call(this)},
...
"binding":function(){var $elf=this,_fromIdx=this.input.idx,name,val;return (function(){name=this._apply("anything");val=this._apply("trans");return ["binding",name,val]}).call(this)},
...
"default":function(){var $elf=this,_fromIdx=this.input.idx,y;return (function(){y=this._apply("trans");return ["default",y]}).call(this)}});var BSJSTranslator=exports.BSJSTranslator=objectThatDelegatesTo(OMeta,{
...
"var":function(){var $elf=this,_fromIdx=this.input.idx,vs;return (function(){vs=this._many1((function(){return this._apply("varItem")}));return ("var " + vs.join(","))}).call(this)},
"varItem":function(){var $elf=this,_fromIdx=this.input.idx,n,v,n;return this._or((function(){return (function(){this._form((function(){return (function(){n=this._apply("anything");return v=this._apply("trans")}).call(this)}));return ((n + " = ") + v)}).call(this)}),(function(){return (function(){this._form((function(){return n=this._apply("anything")}));return n}).call(this)}))},
"throw":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("trans");return ("throw " + x)}).call(this)},
