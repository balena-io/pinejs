...
"number":function(){var $elf=this,_fromIdx=this.input.idx,n,f,f;return this._or((function(){return (function(){switch(this._apply('anything')){case "0":return (function(){this._applyWithArgs("exactly","x");"0x";n=this._apply("hexLit");return ["number",n]}).call(this);default: throw fail}}).call(this)}),(function(){return (function(){f=this._consumedBy((function(){return (function(){this._many1((function(){return this._apply("digit")}));return this._opt((function(){return (function(){this._applyWithArgs("exactly","e");this._opt((function(){return this._applyWithArgs("exactly","-")}));return this._many1((function(){return this._apply("digit")}))}).call(this)}))}).call(this)}));return ["number",parseFloat(f)]}).call(this)}),(function(){return (function(){f=this._consumedBy((function(){return (function(){this._many1((function(){return this._apply("digit")}));return this._opt((function(){return (function(){this._applyWithArgs("exactly",".");return this._many1((function(){return this._apply("digit")}))}).call(this)}))}).call(this)}));return ["number",parseFloat(f)]}).call(this)}))},
"escapeChar":function(){var $elf=this,_fromIdx=this.input.idx,c;return (function(){this._applyWithArgs("exactly","\\");c=this._or((function(){return (function(){switch(this._apply('anything')){case "\"":return "\"";default: throw fail}}).call(this)}),(function(){return this._applyWithArgs("token","\'")}),(function(){return (function(){switch(this._apply('anything')){case "\\":return "\\";case "n":return "n";case "r":return "r";case "t":return "t";case "b":return "b";case "f":return "f";default: throw fail}}).call(this)}),(function(){return this._consumedBy((function(){return (function(){this._applyWithArgs("exactly","u");this._apply("char");this._apply("char");this._apply("char");return this._apply("char")}).call(this)}))}),(function(){return this._consumedBy((function(){return (function(){this._applyWithArgs("exactly","x");this._apply("char");return this._apply("char")}).call(this)}))}),(function(){return this._apply("char")}));return unescape(("\\" + c))}).call(this)},
